...
$d_cpu = "SELECT * FROM $cpuid WHERE `level` = '高端'";
$d_cpu1 = $pdo->query($d_cpu)->fetchAll();

$mbid = '02mb';
$d_mb = "SELECT * FROM 02mb WHERE `level` = '高端'";
...
$d_case = "SELECT * FROM 07computercase WHERE `radiator fan` = '上置風扇,_下置風扇,_側置風扇'";
